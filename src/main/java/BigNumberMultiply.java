...
//        String b = "21";
		...
		// 开始计算: 模拟手算累加
        int[] result = BigNumberMultiply.bigNumberMultiply2(arr1, arr2);
        System.out.println(a + " * " + b + " = " + Arrays.toString(result).replace(", ", ""));

		// karatsuba乘法
		System.out.println("karatsuba乘法 : " + BigNumberMultiply.karatsuba(24566  , 452053));
	}
	...
	public static Integer[] bigNumberMultiply(int[] arr1, int[] arr2){
		ArrayList<Integer> result = new ArrayList<Integer>();  //中间求和的结果
		...
		for(int i = arr2.length - 1; i >= 0; i--){
			...
			ArrayList<Integer> middleResult = new ArrayList<Integer>();
